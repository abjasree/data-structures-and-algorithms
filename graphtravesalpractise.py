...
class Graph:
    ...
    def get_adjacency_list(self):
        ...
        adjacency_list = [[] for i in range(max_index)]
    ...
    def get_adjacency_matrix(self):
        max_index = self.find_max_index()
        adjacency_matrix = [[0] * max_index for i in range(max_index)]
        for edg in self.edges:
    ...
    def bfs(self, start_node_num):
        ...
        def unvisited_outgoing_edge(n, edg):
            return (edg.node_from.value == n.value) and (not edg.node_to.visited)
